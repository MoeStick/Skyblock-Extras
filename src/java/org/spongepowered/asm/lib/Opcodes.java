/* 1 */ package org.spongepowered.asm.lib;public interface Opcodes { public static final Integer UNINITIALIZED_THIS = new Integer(6);
/* 2 */   public static final Integer LONG = new Integer(4);
/* 3 */   public static final Integer NULL = new Integer(5);
/* 4 */   public static final Integer DOUBLE = new Integer(3);
/* 5 */   public static final Integer TOP = new Integer(0);
/* 6 */   public static final Integer FLOAT = new Integer(2);
/* 7 */   public static final Integer INTEGER = new Integer(1);
...
/* Location:              C:\Users\nebul\Downloads\SkyblockExtras-2.1.10.1 (1).jar!\org\spongepowered\asm\lib\Opcodes.class
